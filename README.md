...
This repository contains the Jupyter Notebooks that accompany the Junos Genius cert prepations videos for JNCIA Automation and DevOps.

Jupyter notebooks allow rich text to be combined with programming language interpreters.  The results are local web pages which are great at demonstrating programming concepts.  As the JNCIA-DevOps course covers Python and other programming tools, these learning bytes use Jupyter notebooks in conjunction with the normal video content.
...
If not broswe to: http://localhost:8888/tree
